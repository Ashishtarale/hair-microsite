    ...
    return (function (t) {
        ...
        function (t, e, n) {
            var r = n(1),
                ...
                f = function (t, e, n) {
                    ...
                    d && (n = e);
                    for (a in n)
                        (s = !h && m && void 0 !== m[a]), (l = (s ? m : n)[a]), (p = _ && s ? c(l, r) : y && "function" == typeof l ? c(Function.call, l) : l), m && u(m, a, l, t & f.U), g[a] != l && o(g, a, p), y && x[a] != l && (x[a] = l);
                };
                ...
                return function (e, n) {
                    ...
                    return f < 0 || f >= a
                        ? t
                            ? ""
                            : void 0
                        : ((o = c.charCodeAt(f)), o < 55296 || o > 56319 || f + 1 === a || (u = c.charCodeAt(f + 1)) < 56320 || u > 57343 ? (t ? c.charAt(f) : o) : t ? c.slice(f, f + 2) : u - 56320 + ((o - 55296) << 10) + 65536);
                };
            };
        },
        function (t, e, n) {
            ...
            t.exports = function (t, e, n, d, v, y, _) {
                ...
                if (
                    (T && (x = s(T.call(new t()))) !== Object.prototype && x.next && (a(x, O, !0), r || "function" == typeof x[l] || u(x, l, h)),
                    w &&
                        S &&
                        "values" !== S.name &&
                        ((j = !0),
                    ...
                    if (((m = { values: w ? P : b("values"), keys: y ? P : b("keys"), entries: A }), _)) for (g in m) g in M || o(M, g, m[g]);
            ...
            i(
                ...
                "Array",
                {
                    from: function (t) {
                        ...
                        else for (l = m.call(p), n = new h(); !(i = l.next()).done; _++) a(n, _, y ? u(l, v, [i.value, _], !0) : i.value);
                        return (n.length = _), n;
                    },
                }
            );
        ...
        function (t, e, n) {
            ...
            Object.defineProperty(e, "__esModule", { value: !0 }),
                (e.default = function (t) {
                    var e = t.getBoundingClientRect();
                    return { height: e.height, left: e.left + window.pageXOffset, top: e.top + window.pageYOffset, width: e.width };
                });
        },
        function (t, e, n) {
            "use strict";
